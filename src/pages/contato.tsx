          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="p-6 mt-8 bg-primary/5 border-primary/20">
              <p className="text-sm text-muted-foreground text-center">
                <strong>Nota:</strong> Esta página está em desenvolvimento. As
                informações de contato (telefones, e-mails, endereço) e a
                funcionalidade do formulário serão implementadas em breve.
              </p>
            </Card>
          </div>
        </div>
